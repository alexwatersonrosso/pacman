    ...
    function checkCollisions(item) {
        ...
        if (item.position.y + item.velocity.y + item.newing.height > window.innerHeight || item.position.y + item.velocity.y < 0) item.velocity.y -item.velocity.y;
        //
